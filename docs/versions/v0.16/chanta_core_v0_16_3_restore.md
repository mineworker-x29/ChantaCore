...
- `docs/versions/v0.16/chanta_core_v0_16_3_restore.md`
...
```powershell
rg -n "active_runtime_requested.*False|This binding does not grant new runtime capabilities" src/chanta_core/persona/personal_mode_binding.py tests/test_personal_mode_binding_*.py docs/versions/v0.16/chanta_core_v0_16_3_restore.md
```
